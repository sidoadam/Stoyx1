...
public class ChromaKey_BgColor : KitComponentBase
{
	...
	[Tooltip("ChromaKey_BgColor.shader")]
	...
	void Awake() {
		if (chromaKeyShader == null) {
			chromaKeyShader = Shader.Find("ChromaKeyKit/ChromaKey/ChromaKey_BgColor");
		}
	}
	...
	private void updateShaderProperties() {
		if (_bgColor != bgColor) {
			_bgColor = bgColor;
			_shaderMat.SetColor("_BgColor", _bgColor);
		}
